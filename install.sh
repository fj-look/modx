...
install_x-ui() {
    systemctl stop x-ui
    cd /usr/local/
    url="https://github.com/fj-look/modx/releases/download/refs%2Fheads%2Fmain/x-ui-linux-amd64.tar.gz"
    echo -e "开始安装 x-ui"
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://jsd.cdn.zzko.cn/gh/fj-look/modx@main/x-ui.sh
